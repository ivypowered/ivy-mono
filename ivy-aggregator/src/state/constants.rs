...
pub const HIDDEN_GAMES: [Public; 9] = [
    Public([
...
pub const HIDDEN_SYNCS: [Public; 1] = [Public([
    46, 134, 29, 85, 31, 196, 165, 129, 47, 158, 193, 192, 117, 187, 20, 206, 132, 222, 88, 218,
    146, 146, 96, 128, 62, 42, 116, 5, 12, 110, 166, 253,
])];
