...
import { SyncDisplay, SyncInfo } from "@/components/display/SyncDisplay";

export default function Home() {
    const exampleSync: unknown = {
        name: "Test 3",
        symbol: "TEST3",
        address: "2fLCLygczbqSEEVEYkEiziLeZJX2tA7xXSKPHjto2XmK",
        external_mint: "DPZmm8ketJiRwh5ecmaJFevEpAnsm2KVsvyFWuvJpump",
        create_timestamp: 1755839646,
        metadata_url:
            "https://cdn.ivypowered.com/ipfs/bafkreifj22bkczqbxxvxjetrcxcpc6vw2qjpud6k2vesmeoasosj2vqpue",
        icon_url:
            "https://cdn.ivypowered.com/ipfs/bafkreiffe73bwlghoyq3zapuuwj7r7zl62kczwlokous4lpxprmgocpgmu",
        game_url: "https://example.com",
        description: "test 3",
        is_migrated: false,
        pswap_pool: null,
        last_price_usd: 0.005146101,
        mkt_cap_usd: 5146.101,
        sol_reserves: 30010167668,
        token_reserves: 1072636468095618,
        change_pct_24h: 0.0,
    };
    ...
    return (
        <div className="min-h-screen bg-zinc-900 text-white font-mono">
            ...
            <WalletProvider>
                <></>
                {<SyncDisplay syncInfo={exampleSync as SyncInfo} />}
            </WalletProvider>
